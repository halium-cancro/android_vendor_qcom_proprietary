LITEON_IMX135_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_liteon_imx135_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(LITEON_IMX135_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= liteon_imx135_eeprom.c
LOCAL_MODULE           := libmmcamera_liteon_imx135_eeprom
