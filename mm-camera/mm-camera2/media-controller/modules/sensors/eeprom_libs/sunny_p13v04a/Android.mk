SUNNY_Q13V03A_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_sunny_q13v03a_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(SUNNY_Q13V03A_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= sunny_p13v04a_eeprom.c
LOCAL_MODULE           := libmmcamera_sunny_p13v04a_eeprom
