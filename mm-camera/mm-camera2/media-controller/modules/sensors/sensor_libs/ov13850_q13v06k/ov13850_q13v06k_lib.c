...
#define SENSOR_MODEL_NO_SKUF_OV13850_Q13V06K "ov13850_q13v06k"
#define SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(n) \
  "libchromatix_"SENSOR_MODEL_NO_SKUF_OV13850_Q13V06K"_"#n".so"

#undef DEBUG_INFO
//#define OV13850_Q13V06K_DEBUG
#ifdef OV13850_Q13V06K_DEBUG
#include <utils/Log.h>
...
static struct msm_camera_csid_vc_cfg ov13850_q13v06k_cid_cfg[] = {
  {0, CSI_RAW10, CSI_DECODE_10BIT},
  {1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params ov13850_q13v06k_csi_params = {
  .csid_params = {
    .lane_cnt = 4,
    .lut_params = {
      .num_cid = 2,
      .vc_cfg = {
         &ov13850_q13v06k_cid_cfg[0],
         &ov13850_q13v06k_cid_cfg[1],
      },
    },
  },
  .csiphy_params = {
...
static struct msm_camera_csi2_params *csi_params[] = {
  &ov13850_q13v06k_csi_params, /* RES 0*/
  &ov13850_q13v06k_csi_params, /* RES 1*/
  &ov13850_q13v06k_csi_params, /* RES 2*/
  &ov13850_q13v06k_csi_params, /* RES 3*/
  &ov13850_q13v06k_csi_params, /* RES 4*/
  &ov13850_q13v06k_csi_params, /* RES 5*/
};
...
static struct sensor_pix_fmt_info_t ov13850_q13v06k_pix_fmt0_fourcc[] = {
  { V4L2_PIX_FMT_SBGGR10 },
};

static struct sensor_pix_fmt_info_t ov13850_q13v06k_pix_fmt1_fourcc[] = {
  { MSM_V4L2_PIX_FMT_META },
};

static sensor_stream_info_t ov13850_q13v06k_stream_info[] = {
  {1, &ov13850_q13v06k_cid_cfg[0], ov13850_q13v06k_pix_fmt0_fourcc},
  {1, &ov13850_q13v06k_cid_cfg[1], ov13850_q13v06k_pix_fmt1_fourcc},
};

static sensor_stream_info_array_t ov13850_q13v06k_stream_info_array = {
  .sensor_stream_info = ov13850_q13v06k_stream_info,
  .size = ARRAY_SIZE(ov13850_q13v06k_stream_info),
};
...
static struct msm_camera_i2c_reg_array res1_reg_array[] = {
  /*
  @@Raw 10bit 2104x1560 30fps 4lane 640M bps/lane
  ;XVCLK=24Mhz, SCLK=4x60Mhz, MIPI 640Mbps, DACCLK=240Mhz
  */
  {0x0300, 0x01, 0},// ;for 640Mbps
  {0x0302, 0x28, 0},
  {0x3612, 0x27, 0},
  {0x3501, 0x60, 0},
  {0x370a, 0x27, 0},
...
static struct msm_camera_i2c_reg_array res2_reg_array[] = {
  /*
  @@Raw 10bit 2104x1184 30fps 4lane 640M bps/lane
  ;XVCLK=24Mhz, SCLK=4x60Mhz, MIPI 640Mbps, DACCLK=240Mhz
  */
  {0x0300, 0x01, 0},// ;for 640Mbps
  {0x0302, 0x28, 0},
...
static struct msm_camera_i2c_reg_array res3_reg_array[] = {
  /*
  @@Raw 10bit 1056x594 60fps 4lane 640M bps/lane
  ;XVCLK=24Mhz, SCLK=4x60Mhz, MIPI 640Mbps, DACCLK=240Mhz
  */
  {0x0300, 0x01, 0},
  {0x0302, 0x28, 0},
...
static struct msm_camera_i2c_reg_array res4_reg_array[] = {
  /*
  @@Raw 10bit 1056x594 90fps 4lane 640M bps/lane
  ;XVCLK=24Mhz, SCLK=4x60Mhz, MIPI 640Mbps, DACCLK=240Mhz
  */
  {0x0300, 0x01, 0},
  {0x0302, 0x28, 0},
...
static struct msm_camera_i2c_reg_array res5_reg_array[] = {
  /*
  @@Raw 10bit 1056x594 120fps 4lane 640M bps/lane
  ;XVCLK=24Mhz, SCLK=4x60Mhz, MIPI 640Mbps, DACCLK=240Mhz
  */
  {0x0300, 0x01, 0},// ;for 640Mbps
  {0x0302, 0x28, 0},
...
static sensor_res_cfg_type_t ov13850_q13v06k_res_cfg[] = {
...
static struct sensor_res_cfg_table_t ov13850_q13v06k_res_table = {
  .res_cfg_type = ov13850_q13v06k_res_cfg,
  .size = ARRAY_SIZE(ov13850_q13v06k_res_cfg),
};

static struct sensor_lib_chromatix_t ov13850_q13v06k_chromatix[] = {
  {
    .common_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(snapshot),
    .camera_snapshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(snapshot),
    .camcorder_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(snapshot),
    .liveshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(snapshot),
  },
  {
    .common_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(preview),
    .camera_snapshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(preview),
    .camcorder_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(default_video),
    .liveshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(preview),
  },
  {
    .common_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(preview),
  ...
  {
    .common_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_60fps),
    .camera_snapshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_60fps),
    .camcorder_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_60fps),
    .liveshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_60fps),
  },
  {
    .common_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_90fps),
    .camera_snapshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_90fps),
    .camcorder_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_90fps),
    .liveshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_90fps),
  },
  {
    .common_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_120fps),
    .camera_snapshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_120fps),
    .camcorder_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_120fps),
    .liveshot_chromatix = SKUF_OV13850_Q13V06K_LOAD_CHROMATIX(hfr_120fps),
  },
};

static struct sensor_lib_chromatix_array ov13850_q13v06k_lib_chromatix_array = {
  .sensor_lib_chromatix = ov13850_q13v06k_chromatix,
  .size = ARRAY_SIZE(ov13850_q13v06k_chromatix),
};
 ...
 * DESCRIPTION:
 *==========================================================================*/
static uint16_t ov13850_q13v06k_real_to_register_gain(float gain)
{
 ...
 * DESCRIPTION:
 *==========================================================================*/
static float ov13850_q13v06k_register_to_real_gain(uint16_t reg_gain)
{
  float real_gain;
...
/*===========================================================================
 * FUNCTION    - ov13850_q13v06k_calculate_exposure -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov13850_q13v06k_calculate_exposure(float real_gain,
 ...
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov13850_q13v06k_fill_exposure_array(uint16_t gain,
...
static sensor_exposure_table_t ov13850_q13v06k_expsoure_tbl = {
  .sensor_calculate_exposure = ov13850_q13v06k_calculate_exposure,
  .sensor_fill_exposure_array = ov13850_q13v06k_fill_exposure_array,
};
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  /* sensor eeprom name */
  .eeprom_name = "sunny_q13v06k",
  /* sensor actuator name */
  .actuator_name = "bu64297_q13v06k",
  ...
  /* csi cid params */
  .csi_cid_params = ov13850_q13v06k_cid_cfg,
  /* csi csid params array size */
  .csi_cid_params_size = ARRAY_SIZE(ov13850_q13v06k_cid_cfg),
  /* init settings */
  ...
  .sensor_res_cfg_table = &ov13850_q13v06k_res_table,
  /* res settings */
  ...
  .sensor_stream_info_array = &ov13850_q13v06k_stream_info_array,
  /* exposure funtion table */
  .exposure_func_table = &ov13850_q13v06k_expsoure_tbl,
  /* chromatix array */
  .chromatix_array = &ov13850_q13v06k_lib_chromatix_array,
  /* sensor pipeline immediate delay */
  .sensor_max_immediate_frame_delay = 2,
};

/*===========================================================================
 * FUNCTION    - ov13850_q13v06k_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *ov13850_q13v06k_open_lib(void)
{
