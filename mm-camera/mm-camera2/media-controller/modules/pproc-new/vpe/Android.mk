# ---------------------------------------------------------------------------
#                  Make the shared library (libmmcamera2_vpe_module)
# ---------------------------------------------------------------------------
...
LOCAL_SRC_FILES := vpe_module.c
LOCAL_SRC_FILES += vpe_module_util.c
LOCAL_SRC_FILES += vpe_port.c
LOCAL_SRC_FILES += vpe_thread.c
LOCAL_SRC_FILES += vpe_hardware.c
LOCAL_SRC_FILES += vpe_hw_params.c
