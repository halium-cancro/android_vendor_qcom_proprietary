...
LOCAL_SRC_FILES:= tuning/eztune.c \
                  tuning/eztune_items_0301.c \
                  tuning/eztune_process.c \
                  preview/eztune_preview.c

LOCAL_HAL_PATH = $(LOCAL_PATH)/../../../../../../device/xiaomi/cancro/camera

LOCAL_C_INCLUDES:=$(LOCAL_PATH)
LOCAL_C_INCLUDES+= $(LOCAL_PATH)/tuning/
LOCAL_C_INCLUDES+= $(LOCAL_PATH)/preview/
...
LOCAL_C_INCLUDES+= $(LOCAL_HAL_PATH)/QCamera2/stack/mm-camera-test/inc/

LOCAL_C_INCLUDES+= $(LOCAL_HAL_PATH)/mm-image-codec/qomx_core
LOCAL_C_INCLUDES+= $(LOCAL_HAL_PATH)/mm-image-codec/qexif
LOCAL_C_INCLUDES+= $(LOCAL_PATH)/../../../../../../frameworks/native/include/media/openmax
