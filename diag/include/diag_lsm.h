...
#define DCI_MAX_REQ_BUF_SIZE (4096-8)/* 4 bytes for header 4 bytes for DCI tag(4096-8) since write to kernel supports max of 4k */
#define NUM_PROC 10
...
void diag_switch_logging(int mode, char *dir_location);
/*===========================================================================
