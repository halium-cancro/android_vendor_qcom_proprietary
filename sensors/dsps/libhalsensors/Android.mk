...
LOCAL_SRC_FILES += src/sensors_qcom_hal.c
LOCAL_SRC_FILES += src/sensors_hal_time.c
LOCAL_SRC_FILES += src/sensors_hal_sam_grav.c
LOCAL_SRC_FILES += src/sensors_hal_sam_gamerv.c
LOCAL_SRC_FILES += src/sensors_hal_sam_ori.c
LOCAL_SRC_FILES += src/sensors_hal_sam_ped.c
LOCAL_SRC_FILES += src/sensors_hal_sam_rotv.c
LOCAL_SRC_FILES += src/sensors_hal_sam_thresh.c
